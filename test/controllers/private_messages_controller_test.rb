...
class PrivateMessagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create private_message" do
    assert_difference("PrivateMessage.count") do
      post private_messages_url, params: { private_message: { content: @private_message.content, recipient_id: @private_message.recipient_id, sender_id: @private_message.sender_id } }
    end
  ...
  test "should update private_message" do
    patch private_message_url(@private_message), params: { private_message: { content: @private_message.content, recipient_id: @private_message.recipient_id, sender_id: @private_message.sender_id } }
